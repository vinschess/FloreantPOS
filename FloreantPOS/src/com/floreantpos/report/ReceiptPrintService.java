...
public class ReceiptPrintService {
	...
	private static final SimpleDateFormat reportDateFormat = new SimpleDateFormat("dd/MM/yy, hh:mm a");
...
//	}
	...
	public static void printTransaction(PosTransaction transaction) {
		try {
			...
			TicketPrintProperties printProperties = new TicketPrintProperties("TAX INVOICE", true, true, true);
			printProperties.setPrintCookingInstructions(false);
