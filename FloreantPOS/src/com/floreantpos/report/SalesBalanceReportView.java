...
public class SalesBalanceReportView extends JPanel {
	...
	private void viewReport() throws Exception {
		...
		map.put("allCardReceipts", NumberUtil.formatNumber(report.getAllCardReceiptsAmount()));
		map.put("menuLogReceipts", NumberUtil.formatNumber(report.getMenuLogReceiptsAmount()));
		map.put("eatNowReceipts", NumberUtil.formatNumber(report.getEatNowReceiptsAmount()));
		map.put("deliveryHeroReceipts", NumberUtil.formatNumber(report.getDeliveryHeroReceiptsAmount()));
