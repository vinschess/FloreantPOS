...
import com.floreantpos.bo.actions.AllCardReportAction;
...
import com.floreantpos.bo.actions.DeliveryHeroReportAction;
import com.floreantpos.bo.actions.DrawerPullReportExplorerAction;
import com.floreantpos.bo.actions.EatNowReportAction;
...
import com.floreantpos.bo.actions.MenuLogReportAction;
...
public class BackOfficeWindow extends javax.swing.JFrame {
	...
	private void createReportMenu(JMenuBar menuBar) {
		...
		reportMenu.add(new AllCardReportAction());
